...
DISTILL_CE_PATH=model_output/cross_encoder/models/${CE_MODEL_PATH}                         # The initialized parameter of ce
...
DISTILL_PARA_CE=1                   # The distillation parameter of loss_ce
DISTILL_PARA_CE_DB_DIS=1
DISTILL_PARA_CE_DB_LAYER_SCORE=1
...
python -u -m torch.distributed.launch --nproc_per_node=8 --master_port=${MASTER_PORT} \
    ...
    --distill_para_ce=${DISTILL_PARA_CE} \
    --distill_para_ce_db_dis=${DISTILL_PARA_CE_DB_DIS} \
    --distill_para_ce_db_layer_score=${DISTILL_PARA_CE_DB_LAYER_SCORE} \
    --distill_ce --train_ce\
    --distill_ce_path=${DISTILL_CE_PATH} \
    --distill_db --train_db\
    --distill_db_path=${DISTILL_DB_PATH} \
    --distill_ce_db_layer_score \
