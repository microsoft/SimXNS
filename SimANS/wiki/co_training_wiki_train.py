...
def train(args, model, reranker_model, tokenizer, global_step=0):
    ...
    if global_step != 0:
        ...
        train_dataset = TraditionDataset(train_data_path, tokenizer, num_hard_negatives=args.number_neg, a=args.a, b=args.b,
                                         max_seq_length=args.max_seq_length, max_q_length=args.max_query_length)
    else:
        train_dataset = TraditionDataset(args.origin_data_dir, tokenizer, num_hard_negatives=args.number_neg, a=args.a, b=args.b,
                                         max_seq_length=args.max_seq_length, max_q_length=args.max_query_length)
