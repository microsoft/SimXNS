...
EXP_NAME=run_de_marco_${MAX_SEQ_LEN}_${MAX_Q_LEN}_t5_append_${delimiter}_gqp${gold_query_prob}_${MODEL}_neg${number_neg}_${select_generated_query}_${total_part}_part
...
python -u -m torch.distributed.launch --nproc_per_node=8 --master_port=9589 \
    ...
    --output_dir $OUT_DIR \
    --warmup_steps 2000 --logging_steps 100 --save_steps 1000 --max_steps 20000 \
    --log_dir $TB_DIR \
    --shuffle_positives \
    --fp16 --do_train \
